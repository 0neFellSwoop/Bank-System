...
public class BankTest {
    ...
    public void depositing_twice_through_the_bank_works_as_expected(){
        ...
        assertEquals(balance + AMOUNT * 4, bank.retrieveAccount(ID).getBalance());
    }
